...
class ImageFetcher:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if content_type.startswith('image/'):
                        ext = ImageFetcher.get_extension(response)
    ...
    def total_fetch(index=None, url=None,):
        try:
